      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <a href="/services/plumbing" className="text-base text-gray-500 hover:text-gray-900">
                  Plumbing
                </a>
              </li>
              <li>
                <a href="/services/electrical" className="text-base text-gray-500 hover:text-gray-900">
                  Electrical
                </a>
              </li>
              <li>
                <a href="/services/cleaning" className="text-base text-gray-500 hover:text-gray-900">
                  Cleaning
                </a>
              </li>
              <li>
                <a href="/services/it-support" className="text-base text-gray-500 hover:text-gray-900">
                  IT Support
                </a>
              </li>
            </ul>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-base text-gray-400 text-center">
            &copy; 2025 ServiceConnect, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
